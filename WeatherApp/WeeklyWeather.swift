...
//    var daySixIcon: UIImage
    ...
    init (weatherDictionary: NSDictionary) {
        ...
        dayOneTime = weekDateStringFromUnixtime(dayOneTimeIntValue)
...
//        dayOneIcon = weatherIconFromString(dayOneIconString)
        ...
        dayTwoTime = weekDateStringFromUnixtime(dayTwoTimeIntValue)
...
//        dayTwoIcon = weatherIconFromString(dayTwoIconString)
        ...
        dayThreeTime = weekDateStringFromUnixtime(dayThreeTimeIntValue)
...
//        dayThreeIcon = weatherIconFromString(dayThreeIconString)
        ...
        dayFourTime = weekDateStringFromUnixtime(dayFourTimeIntValue)
...
//        dayFourIcon = weatherIconFromString(dayFourIconString)
        ...
        dayFiveTime = weekDateStringFromUnixtime(dayFiveTimeIntValue)
...
//        dayFiveIcon = weatherIconFromString(dayFiveIconString)
        ...
        daySixTime = weekDateStringFromUnixtime(daySixTimeIntValue)
...
func weekDateStringFromUnixtime(unixTime: Int) -> String {
